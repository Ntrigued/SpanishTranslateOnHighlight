...
export default prompts = {
    ...
    EXTRACT_VERBS: "Respond with a list only of verbs in the following spanish content. Do not have anything else in your response. Ex. ¿Pero ahora el astrobiólogo Milán Cirkovic y sus colegas afirman que han encontrado un error en este razonamiento.? -> [afirman; han; encontrado]\n\n",
